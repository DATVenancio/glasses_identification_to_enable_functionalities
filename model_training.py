...
DATASET_DIRECTORY = r"/home/daniel/Documents/PythonProjects/Glasses_Identification/glasses_identification_to_enable_functionalities/dataset"
CLASSIFICATION_CATEGORIES = ["glasses","no_glasses"]
...
finalModel.save("glasses_detector.model",save_format="h5")
...
plt.figure()
plt.plot(np.arange(0, N), trained_head.history["loss"], label="train_loss")
plt.plot(np.arange(0, N), trained_head.history["val_loss"], label="val_loss")
plt.plot(np.arange(0, N), trained_head.history["accuracy"], label="train_acc")
plt.plot(np.arange(0, N), trained_head.history["val_accuracy"], label="val_acc")
